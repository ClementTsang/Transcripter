...
namespace STTClient
{
    ...
    internal static class NativeImp
    {
        ...
        [DllImport("libstt.so", CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr STT_ErrorCodeToErrorMessage(int aErrorCode);
        ...
        [DllImport("libstt.so", CallingConvention = CallingConvention.Cdecl)]
        internal static extern void STT_FreeMetadata(IntPtr metadata);

        [DllImport("libstt.so", CallingConvention = CallingConvention.Cdecl)]
        internal static extern void STT_FreeString(IntPtr str);
